...
final class LWAlertView: LWBaseAlertView {
...
final class ExchangeAlertView: LWBaseAlertView {
...
class LWBaseAlertView: BaseFlexView {
    private static let approximatedDefaultWidth = 325 as CGFloat
    let statusImageView: UIImageView
    let contentView: UIView
    let titleLabel: UILabel
    var width: CGFloat {
        return UIScreen.main.bounds.width > LWBaseAlertView.approximatedDefaultWidth
            ? LWBaseAlertView.approximatedDefaultWidth

...
final class Configurations {
    ...
    static var defaultLokiNode: LokiNodeDescription {
        #if USE_TESTNET
            NSLog("USING TESTNET NODE")
            return LokiNodeDescription(uri: "lokitestnet.com:38157")
        #endif
      
        return LokiNodeDescription(uri: "imaginary.stream:22023")
    }

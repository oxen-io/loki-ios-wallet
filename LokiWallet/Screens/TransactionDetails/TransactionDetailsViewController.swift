...
//            cell.contentView.roundCorners([.bottomLeft, .bottomRight], radius: 20)
    ...
    private func update(transactionDescription: TransactionDescription) {
        ...
        let fee = getLokiAmount(value: transactionDescription.fee.value)
    ...
    private func getLokiAmount(value: UInt64) -> String {
        guard
            let formattedValue = LokiAmountParser.formatValue(value),

...
#import "LokiPendingTransactionAdapter.h"

#ifndef LokiWalletAdapter_h
#define LokiWalletAdapter_h

@protocol LokiWalletAdapterDelegate
@required
...
@interface LokiWalletAdapter: NSObject
{
   @public struct LokiWalletAdapterMember *member;
}
@property (weak) id<LokiWalletAdapterDelegate> delegate;

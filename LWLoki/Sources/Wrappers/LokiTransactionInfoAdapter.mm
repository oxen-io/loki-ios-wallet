...
#import "LokiTransferAdapter.mm"

struct LokiTransactionInfoMember {
    Loki::TransactionInfo *tx;
};

@implementation LokiTransactionInfoAdapter: NSObject

- (id)initWithMember: (LokiTransactionInfoMember *) _member
{
    self = [super init];
    if (self) {
        member = _member;
